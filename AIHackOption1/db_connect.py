...
try:
    cnx = psycopg2.connect(user="team5hack", password="IneedApa$$word", host="team5-postgres-db.postgres.database.azure.com", port=5432, database="postgres", sslmode='require')
