...
# https://aihac-mfc0kjaa-eastus2.cognitiveservices.azure.com/openai/deployments/gpt-5-chat/chat/completions?api-version=2025-01-01-preview
deployment = os.getenv("DEPLOYMENT_NAME", "gpt-5-chat")
subscription_key = "<omg let me push>"
